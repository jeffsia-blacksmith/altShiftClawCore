...
export function scheduleRuleDescription(rule, lang) {
  ...
  if (rule.ruleType === "once" && typeof rp.run_at === "string") {
    ...
    return t("schedule.run_at_once", { run_at: o.toLocaleString(L === "zh-CN" ? "zh-CN" : "en-GB", { timeZone: "Asia/Kuala_Lumpur", day: "2-digit", month: "2-digit", year: "numeric", hour: "2-digit", minute: "2-digit" }) }, L);
  }
